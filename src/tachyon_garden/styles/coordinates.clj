...
(def styledefs
  ...
  [:absolute-fill {"top" (clojure.core/str "00"),
  ...
  [:absolute-fill-ns {"top" (clojure.core/str "00"),
                      "right" (clojure.core/str "00"),
                      "bottom" (clojure.core/str "00"),
                      "left" (clojure.core/str "00")}]
  ...
  [:absolute-fill-m {"top" (clojure.core/str "00"),
                     "right" (clojure.core/str "00"),
                     "bottom" (clojure.core/str "00"),
                     "left" (clojure.core/str "00")}]
  ...
  [:absolute-fill-l {"top" (clojure.core/str "00"),
                     "right" (clojure.core/str "00"),
                     "bottom" (clojure.core/str "00"),
                     "left" (clojure.core/str "00")}]
  )

(defn top [{:keys [media value] :as params}]
  (with-media (merge params
                     {:styledefs styledefs
                      :value (str "top" (when value (str "-" (name value))))})))

(defn left [{:keys [media value] :as params}]
  (with-media (merge params
                     {:styledefs styledefs
                      :value (str "left" (when value (str "-" (name value))))})))
(defn right [{:keys [media value] :as params}]
  (with-media (merge params
                     {:styledefs styledefs
                      :value (str "right" (when value (str "-" (name value))))})))

(defn bottom [{:keys [media value] :as params}]
  (with-media (merge params
                     {:styledefs styledefs
                      :value (str "bottom" (when value (str "-" (name value))))})))

(defn absolute-fill [{:keys [media value] :as params}]
  (with-media (merge params
                     {:styledefs styledefs
                      :value (str "absolute-fill" (when value (str "-" (name value))))})))
