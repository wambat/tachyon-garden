...
(def styledefs
  {:dim [{"opacity" (clojure.core/str "11"),
   ...
   :glow [{"transition" (clojure.core/str "opacity" " " ".15s" " " "ease-in")}
          [":hover" {"opacity" (clojure.core/str "11"),
                     "transition" (clojure.core/str "opacity" " " ".15s" " " "ease-in")}]
          [":focus" {"opacity" (clojure.core/str "11"),
                     "transition" (clojure.core/str "opacity" " " ".15s" " " "ease-in")}]]
   :hide-child [[">.child" {"opacity" (clojure.core/str "00"),
                            "transition" (clojure.core/str "opacity" " " ".15s" " " "ease-in")}]
                [":hover" [">.child" {"opacity" (clojure.core/str "11"),
                                      "transition"
                                      (clojure.core/str "opacity" " " ".15s" " " "ease-in")}]]
                [":focus" [">.child" {"opacity" (clojure.core/str "11"),
                                      "transition"
                                      (clojure.core/str "opacity" " " ".15s" " " "ease-in")}]]
                [":active" [">.child" {"opacity" (clojure.core/str "11"),
                                       "transition"
                                       (clojure.core/str "opacity" " " ".15s" " " "ease-in")}]]]
